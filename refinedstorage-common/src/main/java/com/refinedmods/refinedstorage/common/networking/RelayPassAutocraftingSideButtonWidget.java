...
class RelayPassAutocraftingSideButtonWidget extends AbstractYesNoSideButtonWidget {
    ...
    private static final ResourceLocation YES = createIdentifier("widget/side_button/relay/pass_autocrafting/yes");
    private static final ResourceLocation NO = createIdentifier("widget/side_button/relay/pass_autocrafting/no");
